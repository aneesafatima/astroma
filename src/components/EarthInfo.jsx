  ...
  return (
    <div className="md:h-screen min-h-screen bg-black flex flex-wrap md:flex-nowrap items-center justify-center py-16 xxs:px-10 sm:px-0 md:pr-10 text-[#717070] pointer-events-none ">
      ...
      <div className="sm:w-[80%] text-sm text-white font-medium space-y-4 px-10">
        <p className="">
          <span className="text-2xl font-lato uppercase text-[#3a3b3d] font-light">
            Planet Earth
          </span>
          , located approximately 150 million kilometers (93 million miles) from
          the Sun, occupies a pivotal position in our solar system. Its distance
          ensures a temperate climate conducive to life, maintained by a unique
          atmosphere primarily composed of nitrogen and oxygen. Earth's surface,
          encompassing 71% water and 29% landmass, supports a breathtaking
          diversity of ecosystems, from lush rainforests to expansive deserts.
        </p>
        <p>
